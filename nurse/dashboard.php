...
<div class="box col-md-10" style="margin:0 0 0 244px; width:84%; ">
	<div class="panel panel-default" style="margin-top:2px; margin-bottom:2px; background:#19d5dc;"> <div class="panel-body">
	            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-purple" style="background:#ccc;">
                        ...
                        <a href="viewBloodBank.php">
                            <div class="panel-footer">
                                <span class="pull-left">Blood Banks</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
