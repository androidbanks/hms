...
<div class="form-group"> 
		...
		<div class="form-group"> 
			...
			<div class="col-sm-6"> 
				...
				<?php 
										 ...
										 $pname='SELECT * FROM patient ';
										 $patient=mysql_query($pname);
										 while($name=mysql_fetch_array($patient)){
		...
		<div class="form-group"> 
			<div class="col-sm-offset-2 col-sm-10"> 
				<button name="register" class="btn btn-primary" type="submit" id="add" value="">Add Allotment</button>
			</div> 
		</div> 
	</form> 
	 </div></div>
