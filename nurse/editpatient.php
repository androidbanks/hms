...
<?php
  $query=mysql_query("select * from patient where patient_id='$patient_id'")or die(mysql_error());
$row=mysql_fetch_array($query);
  ?>					
					<form method="post" enctype="multipart/form-data" class="form-horizontal" style="margin-left:175px;">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label">OPDNumber</label>
							<div class="col-sm-4">
							  <input type="text" name="OPDNumber" value="<?php echo $row['OPDNumber']; ?>" class="form-control" id="inputEmail3" placeholder="Firstname.....">
							</div>
						  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-4">
						  <input type="text" name="surname" value="<?php echo $row['surname']; ?>" class="form-control" id="inputEmail3" placeholder="Firstname.....">
						</div>
					  </div>
					   ...
					   <div class="form-group">
						...
						<div class="col-sm-4">
						  <input type="text" name="email" value="<?php echo $row['email']; ?>" class="form-control" id="inputEmail3" placeholder="Firstname.....">
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-4">
						  <select type="text" name="category" value="<?php echo $row['category']; ?>" class="form-control" id="inputEmail3" placeholder="Firstname.....">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-4">
						  <input type="text" name="address" value="<?php echo $row['address']; ?>" class="form-control" id="inputEmail3" placeholder="Firstname.....">
						</div>
					  </div>
					  
					  <div class="form-group">
						<label for="inputEmail3" class="col-sm-3 control-label">Phone Contact</label>
						<div class="col-sm-4">
						  <input type="text" name="phone" value="<?php echo $row['phone']; ?>" class="form-control" id="inputEmail3" placeholder="Firstname.....">
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-4">
						 <select type="text" name="sex" value="<?php echo $row['sex']; ?>" class="form-control" id="inputEmail3" placeholder="Firstname.">
							<option>Male</option>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-4">
						  <input type="text" name="age" value="<?php echo $row['age']; ?>" class="form-control" id="inputEmail3" placeholder="Firstname.....">
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-4">
						  <select type="text" name="blood_group" value="<?php echo $row['blood_group']; ?>" class="form-control" id="inputEmail3" placeholder="Firstname">
								<option>A+</option>
								<option>A-</option>
								<option>B+</option>
								<option>B+</option>
...
<?php
$bed_allotment_id=$_GET['patient_id'];
...
$history_record=mysql_query("select * from patient");
$row=mysql_fetch_array($history_record);
$user=$row['blood_group_id']." ".$row['patient_id'];

{
	

mysql_query("UPDATE `cms`.`patient` SET `OPDNumber` = '$OPDNumber', `firstname` = '$firstname', `surname` = '$surname', `email` = '$email', `category` = '$category', `address` = '$address', `phone` = '$phone', `sex` = '$sex', `age` = '$age', `blood_group` = '$blood_group' WHERE `patient`.`patient_id` = '$patient_id';")or die(mysql_error());
echo "<script>alert('Successfully Patient details Info!'); window.location='ViewBloodBank.php'</script>";
}
