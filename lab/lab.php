	...
	<div class="panel panel-default" style="margin-top:2px; width:100%; margin-bottom:2px; background:#19d5dc;"> <div class="panel-body">
                    ...
                    <div class="panel panel-purple" style="background:#ccc;">
                        ...
                        <a href="labdiagnosis.php">
                            <div class="panel-footer">
                                <span class="pull-left">Add Diagnosis Report</span>
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="panel panel-purple" style="background:#ccc;">
                        ...
                        <a href="labbloodbank.php">
                            <div class="panel-footer">
                                <span class="pull-left">Manage Blood Bank</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
				...
				<div class="col-lg-3 col-md-3">
                    <div class="panel panel-purple" style="background:#ccc;">
                        ...
                        <a href="labdonor.php">
                            <div class="panel-footer">
                                <span class="pull-left">Manage Blood Donor</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                    ...
                    <div class="panel panel-default" >
						...
						while($row = mysql_fetch_array( $result )) {
							?>
                                ...
                                <a href="<?php echo "labnot.php"; ?>" class="list-group-item">
