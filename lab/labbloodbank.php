...
<ul class="nav nav-tabs"> 
	<li><a href="pharprovide.php" >View Prescription</a></li> 
	...
	<?php 
        include_once('connect_db.php');		
        $result = mysql_query("SELECT * FROM blood_bank") or die(mysql_error());
        echo "<table class='table table-bordered table-hover table-striped'>";
        echo "<tr> <th>blood_group</th><th>status</th> <th>blood_donor_id</th>   <th></th><th></th> </tr>";
