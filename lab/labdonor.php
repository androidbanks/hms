...
<div id="header">
	...
	<h3><i class="fa fa-file-pdf-o fa-2x"></i>Diagnosis Report</h3>
	</div>
<ul class="nav nav-tabs"> 
	...
	<?php 
        include_once('connect_db.php');		
        $result = mysql_query("SELECT * FROM blood_donor") or die(mysql_error());
        echo "<table class='table table-bordered table-hover table-striped'>";
        echo "<tr> <th> Donor's Name</th>  <th>Blood Group</th> <th>Gender</th> <th>Age</th>
		<th>Phone</th> <th>Email</th> <th>Physical  Address</th> <th>Last Donation</th>   <th></th><th></th> </tr>";
        while($row = mysql_fetch_array( $result )) {
                ...
                echo '<td>' . $row['last_donation_timestamp'] . '</td>';
