...
<ul class="nav nav-tabs"> 
	<li><a href="pharcategory.php" >View Medicine Category</a></li> 
	<li><a href="pharcategoryadd.php" >Add Medicine Category</a></li> 
</ul>
	...
	<?php 
        include_once('connect_db.php');		
        $result = mysql_query("SELECT * FROM medicine_category") or die(mysql_error());
        echo "<table class='table table-bordered table-hover table-striped'>";
        echo "<tr> <th>med_name</th><th>description</th>  <th></th><th></th> </tr>";
