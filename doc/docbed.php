...
<ul class="nav nav-tabs"> 
	...
	<?php 
        include_once('connect_db.php');		
        $result = mysql_query("SELECT b.bed_number,p.firstname, p.surname,a.allotment_timestamp FROM bed b, patient p, bed_allotment a WHERE b.bed_id=a.bed_id AND p.patient_id=a.patient_id") or die(mysql_error());
        echo "<table class='table table-bordered table-hover table-striped'>";
        echo "<tr> <th>ID</th><th>Bed Number</th> <th>Patient's Name</th> <th>Allotment Time </th><th></th><th></th> </tr>";
